...
namespace cip {
	...
	typedef uint8_t CipByte; /**< 8-bit bit unsigned integer */
	typedef uint16_t CipWord; /**< 16-bit bit unsigned integer */
	typedef uint32_t CipDword; /**< 32-bit bit unsigned integer */
